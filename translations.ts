...
export const translations: Record<'en' | 'ta', TranslationSchema> = {
  ta: {
    ...
    hero: {
      ...
      sannadhi: 'சந்நிதி',
      description: 'கந்தமங்கலத்தில் உள்ள ஜகத்குரு காஞ்சி ஸ்ரீ பரமாச்சார்யாள்களின் புனிதமான சந்நிதிக்கு உங்களை அன்புடன் வரவேற்கிறோம்.',
    ...
    pidiArisi: {
      ...
      verseEn: 'Among all donations, Annadhanam (food donation) is considered the greatest, as stated in our Vedas and Shastras.',
      howTitle: '🌾 பங்கேற்பது எப்படி?',
      step1: 'தினசரி சமையல்',
      step1Desc: 'தினமும் சமையல் தொடங்கும் முன் ஒரு பிடி அரிசியையும் ஒரு நாணயத்தையும் ஒதுக்கி வைக்கவும்.',
      ...
      step3: 'அன்னதானம்',
      step3Desc: 'சேகரிக்கப்பட்ட அரிசி சமைக்கப்பட்டு, பகவானுக்கு படைக்கப்பட்டு, ஏழைகளுக்கு அன்னதானமாக வழங்கப்படும்.',
      ...
      periyavaWords: '"மக்கள் எல்லோருமே குறிப்பாக ஏழைகள் வருந்தாமல் வாழ வேண்டும் என்ற பெரும் நோக்குடன் கருணை உள்ளம் கொண்டு... ஜகத்குரு காஞ்சீ ஸ்ரீபரமாசார்யாள் இதை அநுக்ரஹித்தார்கள்."',
    ...
    about: {
      ...
      p1: 'கந்தமங்கலம் என்பது தமிழ்நாட்டின் நாகப்பட்டினம் மாவட்டத்தில் குத்தாலம் தாலுகாவில் கோமலுக்கு அருகில் அமைந்துள்ள ஒரு கிராமம்.',
      ...
      templesTitle: '🛕 கந்தமங்கலத்தில் உள்ள கோவில்கள்',
      templeList: [
  ...
  en: {
    ...
    hero: {
      ...
      sannadhi: 'Sannadhi',
      description: 'Welcome to the sacred abode of Jagadguru Kanchi Sri Paramacharyal in Kandhamangalam, where devotion meets divine grace.',
    ...
    pidiArisi: {
      ...
      verse: 'தானங்களில் மிகச்சிறந்தது அன்னதானம் என்று நம் வேதம், சாஸ்திரங்களும், புராணங்களும், ஸ்ம்ருதிகளும் கூறுகின்றன.',
      verseEn: 'Among all donations, Annadhanam (food donation) is considered the greatest, as stated in our Vedas, Shastras, Puranas, and Smrithis.',
      ...
      step3Desc: 'The collected rice is cooked, offered to Bhagavan at a nearby temple, and then distributed as annadhanam to the poor.',
      ...
      periyavaWordsEn: '"Jagadguru Kanchi Sri Paramacharyal blessed this Pidi Arisi Thittam 25 years ago so that all people, especially the poor, may live without suffering."',
      cta: '🙏 Contribute to Pidi Arisi Thittam'
    },
    about: {
      badge: 'About Us',
      title: 'Kandhamangalam Sannadhi',
      p1: 'Kandhamangalam is a village near Komal in Kuttalam Taluk in Nagapattinam District of Tamil Nadu State, India.',
      ...
      templesTitle: '🛕 Temples in Kandhamangalam',
      templeList: [
