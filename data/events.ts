...
const hardcodedAnushamEvents: Event[] = [
  {
    ...
    title: "ANUSHAM POOJA",
    date: "July 24, 2026",
    description: "Anusham pooja for Sri Mahaperiyava held on 24th July, 2026.",
    programs: [
      "Avahanthi Homam",
      "Periyava Panchalogha Vighragham & Padhukha Purappadu along with Uthagashanthi parayanam",
      "Annadhanam"
    ],
    donors: ["Mr. Krishnan (Chennai)"],
    mediaUrl: "https://photos.app.goo.gl/kVMPwZCuhwTvKcCS6"
  },
  {
    id: "anusham-mar-2026",
    title: "ANUSHAM POOJA",
    date: "March 10, 2026",
    description: "Anusham pooja for Sri Mahaperiyava held on 10th March, 2026.",
    programs: [
      "Avahanthi Homam",
      "Periyava Panchalogha Vighragham & Padhukha Purappadu along with Uthagashanthi parayanam",
      "Annadhanam"
