        ...
        <div className="relative group max-w-4xl mx-auto">
          ...
          <div className="bg-[#FFFEFB] p-10 md:p-20 rounded-sm shadow-[0_20px_60px_rgba(139,69,19,0.08)] border border-[#D4AF37]/20 relative">
            ...
            {isLoading ? (
              ...
              <div className="space-y-10 md:space-y-12 animate-in fade-in duration-1000">
                {/* Tamil Content - Bold, Dark Brown */}
                <p className="text-2xl md:text-4xl font-bold text-[#2C1810] leading-[1.6] tamil-font text-center max-w-3xl mx-auto">
                  {quoteData.ta}
                </p>

                {/* English Content - Italicized Saffron */}
                <p className="text-lg md:text-2xl italic text-[#FF6B35] leading-relaxed quote-font text-center max-w-2xl mx-auto font-medium">
                  {quoteData.en}
                </p>

                {/* Attribution - Bottom Right */}
                <div className="text-right pt-6 border-t border-[#D4AF37]/10">
                  <p className="text-[#2C1810] font-bold text-xl md:text-2xl heading-font italic">
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-6">
            <button 
              onClick={onRefresh}
              disabled={isLoading}
              className="flex items-center gap-3 bg-white hover:bg-orange-50 text-secondary border border-accent/30 px-8 py-4 rounded-full font-bold text-[10px] md:text-xs uppercase tracking-[0.3em] shadow-lg transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-50"
            >
            ...
            <button 
              ...
              className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1ebd5b] text-white px-8 py-4 rounded-full font-bold text-[10px] md:text-xs uppercase tracking-[0.3em] shadow-lg transition-all transform hover:-translate-y-1"
            >
